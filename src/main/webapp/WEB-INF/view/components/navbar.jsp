...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #DCECA0;">
        ...
        <p style="font-size:20px;">
          <b>
              Online food ordering is the process of ordering food, for delivery or pickup,
               ...
               food (e.g., direct from a home-kitchen, restaurant, or a virtual restaurant) 
               or food that has not been specially prepared for direct consumption 
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="resources/images/phonee.png" style="width:27px;" alt="img">+91 9834505584<br>
                <img src="resources/images/emaill.png" style="width:29px;" alt="img">sunilrankhamb19081@gmail.com
            </b>
        </p>
        </div>
      </div>
