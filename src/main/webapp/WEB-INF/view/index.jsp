	...
	<div id="carouselExampleIndicators" class="carousel slide"
		...
		<div class="carousel-inner" style="width: 100%">
			<div class="carousel-item active">
				<img class="d-block w-100" src="resources/images/carousal.jpeg" height="190px" alt="First slide">
			</div>
			<div class="carousel-item">
				<img class="d-block w-100" src="resources/images/carousal2.webp" height="190px" alt="Second slide">
			</div>
		</div>
                         ...
                         <div class="card">
                             ...
                             <div class="card-footer text-center">
                                 ...
                                 <span class="ml-2" style="font-size:20px;color:red"><s>&#8377;<%=p.getPrice()%></s></span>
                                  ...
                                  <h5><a href="food?foodId=<%=p.getId()%>"> <button>Add Cart</button></a></h5>
